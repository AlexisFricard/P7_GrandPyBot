...
def test_if_stopWords_was_removed_then_cleaning_sentence(monkeypatch):
    ...
    monkeypatch.setattr('app.grandpy.modules.parser.parser.Parser.get_stopWords',
        mock_get_stopWords)
    monkeypatch.setattr('app.grandpy.modules.parser.parser.Parser.remove_special_char',
